...
sudo DEBIAN_FRONTEND=noninteractive aptitude markauto -y '~i!~nubuntu-minimal ~i!~nca-certificates -~i!~napt-transport-https ~i!~napt ~i!~nopenssl ~i!~ntime ~i!~nopenssh-server'
